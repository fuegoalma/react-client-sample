...
Three suites, mirroring the API's own split. **390 Vitest tests** across 33 files
(168 unit + 222 functional) at **100% coverage — lines, branches, functions and
statements** — plus **21 Playwright specs**.
